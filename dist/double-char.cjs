(function (global, factory) {
  ...
  const quadToChars = function (quad, map) {
    ...
    // | 3 7 |
    // | 4 8 |
    var bitsOne = [quad[0][0], quad[1][0], quad[2][0], quad[3][0], quad[0][1], quad[1][1], quad[2][1], quad[3][1]];
    var bitsTwo = [quad[0][2], quad[1][2], quad[2][2], quad[3][2], quad[0][3], quad[1][3], quad[2][3], quad[3][3]];
    return mapBitsToChar(boolArr2DToIndexes(bitsOne).join(''), map) + mapBitsToChar(boolArr2DToIndexes(bitsTwo).join(''), map);
  };
